      ...
      <motion.div className="w-full max-w-md text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        {sent ? (
          <>
            ...
            <p className="text-xs tracking-[0.2em] uppercase font-medium mb-2" style={{ color: '#A8863A' }}>{t('forgotPassword_successCategory')}</p>
            <h1 className="font-serif text-2xl font-light mb-2" style={{ color: '#3D2B1F' }}>{t('forgotPassword_successTitle')}</h1>
          ...
          <>
            ...
            <p className="text-xs tracking-[0.2em] uppercase font-medium mb-2" style={{ color: '#A8863A' }}>{t('forgotPassword_category')}</p>
            <h1 className="font-serif text-2xl font-light mb-2" style={{ color: '#3D2B1F' }}>{t('forgotPassword_title')}</h1>
            <p className="text-sm mb-8" style={{ color: '#8B7355' }}>{t('forgotPassword_subtitle')}</p>

            <form onSubmit={handleSubmit} className="space-y-5 text-left">
              <div>
                <label className="block text-xs font-medium tracking-wider uppercase mb-2" style={{ color: '#5C3D2A' }}>{t('forgotPassword_email')}</label>
